...
namespace WorldPackets
{
    namespace Movement
    {
        ...
        struct MovementMonsterSpline
        {
            ...
            uint8 StopDistanceTolerance = 0;    // Determines how far from spline destination the mover is allowed to stop in place 0, 0, 3.0, 2.76, numeric_limits<float>::max, 1.1, float(INT_MAX); default before this field existing was distance 3.0 (index 2)
            MovementSpline Move;
        };
